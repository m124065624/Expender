...
//		Step1.Main.main(null);
	...
	{
		HashMap<String, ArrayList<String>> fileData = readParseResult(Var.tempFile);
...
//			System.out.println("=============================================");
	...
	{
		br = new BufferedReader(new InputStreamReader(new FileInputStream(new File(Var.javaSource))));
		bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(new File(Var.javaDest))));
		String line;
		int lineNum = 0;
		while ((line = br.readLine()) != null)
		{
			lineNum++;
			bw.write(line);
			for (String id : Var.IdLineInFile.keySet())
			{
				if (Var.IdLineInFile.get(id) == lineNum)
				{
