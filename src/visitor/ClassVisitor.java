...
//				System.out.println(compilationUnit.getLineNumber(variableDeclarationFragment.getStartPosition()));
				Var.IdLineInFile.put(variableDeclarationFragment.resolveBinding().getKey(), line);
		...
		for (Object object : interfaces)
		{
			...
			Var.IdLineInFile.put(id, compilationUnit.getLineNumber(node.getStartPosition()));
